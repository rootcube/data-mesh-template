{% macro upload_exposures(exposures) -%}
    {{ return(adapter.dispatch("get_exposures_dml_sql", "dbt_common")(exposures)) }}
{%- endmacro %}
...
{% macro default__get_exposures_dml_sql(exposures) -%}
    ...
    {% if exposures != [] %}
        ...
        select
            ...
            {{ adapter.dispatch('parse_json', 'dbt_common')(adapter.dispatch('column_identifier', 'dbt_common')(6)) }},
            ...
            {{ adapter.dispatch('parse_json', 'dbt_common')(adapter.dispatch('column_identifier', 'dbt_common')(14)) }}
        from values
